...
export async function POST(request) {
  try {
    const { username, email, password, organization,organization_id } = await request.json();
    const db = await connectToDatabase();
...
export async function PUT(request) {
  try {
    const { _id, username, email, password, organization,organization_id } = await request.json();
    const db = await connectToDatabase();
