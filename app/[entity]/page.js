...
const entityConfig = {
  ...
  users: {
    ...
    fields: [
      ...
      { name: 'organization', type: 'select', placeholder: 'Organization', required: true },
  ...
  vendors: {
    name: 'Vendors',
    fields: [
      { name: 'name', type: 'text', placeholder: 'Vendor Name', required: true },
      { name: 'address', type: 'text', placeholder: 'Address' },
      { name: 'contact', type: 'text', placeholder: 'Phone Number' },
      { name: 'email', type: 'email', placeholder: 'Email' },
      { name: 'organization', type: 'select', placeholder: 'Organization', required: true },
  ...
  customers: {
    name: 'Customers',
    fields: [
      { name: 'name', type: 'text', placeholder: 'Customer Name', required: true },
      { name: 'address', type: 'text', placeholder: 'Address' },
      { name: 'contact', type: 'text', placeholder: 'Phone Number' },
      { name: 'email', type: 'email', placeholder: 'Email' },
      { name: 'organization', type: 'select', placeholder: 'Organization', required: true },
  ...
  products: {
    name: 'Products',
    fields: [
      { name: 'reference', type: 'text', placeholder: 'Reference', required: true },
      { name: 'name', type: 'text', placeholder: 'Product Name', required: true },
      {name: 'organization', type: 'select', placeholder: 'Organization', required: true},
      {name: 'product_category', type: 'select', placeholder: 'Product Category', required: true},
  ...
  return (
    ...
    <>
      <MotionConfig transition={{ type: "spring", bounce: 0, duration: 0.4 }}>
          ...
          <div className="app">
            {/* Render the dynamic entity page based on the entity derived from the pathname */}
            {entity ? (
                <div className="app">
          <Sidebar />
      ...
      <div className="mb-6">
              ...
              <h1 className="text-3xl mb-4 font-">{entity.name}</h1>
              <button
              ...
              >
               ...
               {params.entity === "products" ? (
                  ...
                  <DynamicTable
                  data={data}
                  headers={entity.fields.map(field => field.name.charAt(0).toUpperCase() + field.name.slice(1))}
